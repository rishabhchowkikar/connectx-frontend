...
//         desc: "Host large group sessions with crystal-clear quality.",
...
//         desc: "Your conversations remain private and secure.",
...
// const RECENT_ROOMS = [
//     { id: "team-standup-xyz", name: "Team Standup", participants: 4, date: "Today, 9:30 AM" },
//     { id: "design-review-abc", name: "Design Review", participants: 7, date: "Yesterday, 3:00 PM" },
//     { id: "product-sync-def", name: "Product Sync", participants: 12, date: "Mar 2, 11:00 AM" },
// ];
...
//         const newRoom = `group-${uuidv4().slice(0, 8)}`;
...
//     const startNow = () => {
//         if (generatedRoom) {
//             router.push(`/call/${generatedRoom}`);
//         }
//     };
...
//         const url = `${window.location.origin}/call/${generatedRoom}`;
...
//                         Start an instant group video call or join an existing room. No account sharing, no downloads — just seamless collaboration.
//                     </p>
//                 </div>
//             </div>
...
//                                             Create a new group room instantly. Share the link with participants so they can join with one click.
//                                         </p>
//                                         <button
//                                             id="btn-create-room"
...
//                                                 Room ID
//                                             </label>
//                                             <div className="bg-slate-50 border border-slate-200 rounded-xl p-3.5 font-mono text-slate-700 text-sm tracking-wide">
//                                                 {generatedRoom}
//                                             </div>
//                                         </div>
...
//                                                         ? `${window.location.origin}/call/${generatedRoom}`
//                                                         : ""}
//                                                 </span>
//                                                 <button
//                                                     id="btn-copy-link"
...
//                                                         : "bg-white border border-slate-200 text-slate-600 hover:bg-indigo-50 hover:text-indigo-700 hover:border-indigo-200 shadow-sm"
//                                                         }`}
//                                                 >
//                                                     {copied ? (
...
//                                                 id="btn-start-now"
//                                                 onClick={startNow}
//                                                 className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-600 to-violet-700 hover:from-indigo-700 hover:to-violet-800 text-white font-semibold px-6 py-3.5 rounded-xl shadow-md shadow-indigo-200 transition-all hover:scale-[1.01] active:scale-[0.99] text-sm"
//                                             >
...
//                                     </h2>
//                                     <p className="text-slate-500 text-sm max-w-sm mb-8">
//                                         Enter the room ID or paste the invite link shared with you to join instantly.
//                                     </p>
//                                 </div>
...
//                                             id="input-room-id"
//                                             type="text"
//                                             placeholder="e.g. group-a1b2c3d4"
//                                             value={roomIdInput}
//                                             onChange={(e) => setRoomIdInput(e.target.value)}
//                                             onKeyDown={(e) =>
//                                                 e.key === "Enter" && roomIdInput.trim() && joinRoom()
//                                             }
...
//                                             className={`absolute right-2 top-1/2 -translate-y-1/2 p-2.5 rounded-lg transition-all ${roomIdInput.trim()
...
//                             <div
//                                 key={f.title}
//                                 className={`${f.bg} ${f.border} border rounded-xl p-5 group hover:shadow-md transition-all`}
//                             >
//                                 <div
//                                     className={`w-10 h-10 rounded-lg bg-gradient-to-br ${f.color} flex items-center justify-center text-white mb-4 shadow-sm group-hover:scale-110 transition-transform`}
//                                 >
//                                     {f.icon}
//                                 </div>
//                                 <h4 className={`font-semibold text-sm ${f.text} mb-1`}>
//                                     {f.title}
//                                 </h4>
...
//                                             {room.participants} participants · {room.date}
//                                         </p>
//                                     </div>
//                                 </div>
//                                 <button
//                                     onClick={() => router.push(`/call/${room.id}`)}
//                                     className="opacity-0 group-hover:opacity-100 text-xs font-semibold text-indigo-600 hover:text-indigo-800 bg-indigo-50 hover:bg-indigo-100 px-3 py-1.5 rounded-lg transition-all flex items-center gap-1.5"
//                                 >
//                                     Rejoin <ArrowRight className="w-3 h-3" />
//                                 </button>
//                             </div>
//                         ))}
//                     </div>
